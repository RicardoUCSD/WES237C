...
Reverse_Operation:
	...
	{
#pragma HLS PIPELINE
//#pragma HLS unroll factor = 4 //WAS 4, ng: 9
		i_1 = i + 1;
		idx = LUT_MAP[i];
		idx_1 = LUT_MAP[i_1];
...
#pragma HLS PIPELINE
	...
	{
		unsigned short j, j_lower, k, idx;
		DTYPE  c_twiddle, s_twiddle; //was DTYPE
		DTYPE  in_R, in_I, in_R_lower, in_I_lower, temp_R, temp_I; //DTYPE
